package com.example.database_part_3.SWIPE_TO_EDIT_MESSAGE


/* to swipe left edit the message and reedit the message */
...
class swipe_to_edit(private val context: Context,
    ...
    private fun setTouchListener(recyclerView: RecyclerView,
        ...
        recyclerView.setOnTouchListener{ _,event->
            ...
            if(swipeBack){
                if (Math.abs(mView.translationX) >= this.convertTodp(100)) {
